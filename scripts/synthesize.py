...
def synthesize(args, dur_factor=None, energy_factor=None, pitch_factor=None, 
    ...
    refs = ['/workdir/repo_dir/scripts/style_bank/english/es001_neutral_006.npz', 
            '/workdir/repo_dir/scripts/style_bank/english/es002_angry_020.npz', 
            '/workdir/repo_dir/scripts/style_bank/english/es003_neutral_129.npz',
            '/workdir/repo_dir/scripts/style_bank/english/es001_angry_400.npz', 
            '/workdir/repo_dir/scripts/style_bank/english/es003_neutral_129.npz', 
            '/workdir/repo_dir/scripts/style_bank/english/es002_neutral_145.npz',
            ]
    # refs = ['/workdir/repo_dir/scripts/style_bank/english/en001_neutral_114.npz', '/workdir/repo_dir/scripts/style_bank/english/en002_enthusiastic_114.npz', '/workdir/repo_dir/scripts/style_bank/english/en003_angry_114.npz']
    # choose a random speaker ID per sentence
    speaker_ids = [random.choice(hparams.speakers_id) for _ in range(len(sentences))]
    speaker_ids = [96, 29, 98, 96, 29, 98]
