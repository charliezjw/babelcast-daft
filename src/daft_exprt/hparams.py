...
class HyperParams(object):
    def __init__(self, verbose=True, **kwargs):
        ...
        self.seed = 42  # seed used to initialize weights
        ...
        self.cudnn_deterministic = False  # parameter used when initializing training
        self.dist_backend = 'nccl'  # parameter used to perform distributed training
        self.nb_iterations = 5700000  # total number of iterations to perform during training
        ...
        self.batch_size = 64  # batch size per GPU card
        self.accumulation_steps = 1  # number of iterations before updating model parameters (gradient accumulation)
